    ...
    _createClass(ExcelFile, [{
        ...
        value: function download() {
            ...
            _react2.default.Children.forEach(this.props.children, function (c) {
                //added: allow null children in component
                if(c != null) children.push(c);
            });
            var wb = {
                SheetNames: _react2.default.Children.map(children, function (sheet) {
                    return sheet.props.name;
                }),
                Sheets: {}
            };

            _react2.default.Children.forEach(children, function (sheet) {
                //added: removed === 0 check
            ...
            //added: added saveAs parameter
            (0, this.props.saveAs || _fileSaver.saveAs)(new Blob([(0, _DataUtil.strToArrBuffer)(wbout)], { type: "application/octet-stream" }), fileName);
        }
    }, {
        key: "getFileName",
